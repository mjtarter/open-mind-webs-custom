...
$services = array("Database Management", "Photography");
$description = "This client had an ENORMOUS collection of sports memorabilia and needed a cost efficient way to organize it to know everything that he had as well as to have paperwork for insurance purposes. I photographed each item and then created an excel spreadsheet that includes thumbnail photos of the front and back of each item (can be clicked to enlarge), Id #’s, Descriptions, and item type (autograph, card, poster, basketball, etc).";
